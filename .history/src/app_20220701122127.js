...
class App extends React.Component {
  ...
  onPost = (data) => {
    ...
    if (this.state.elementList.length === 0) {
      ...
      this.setState({ _length_before_modify: s.state.elementList.task_data.length });
      
      //this.state.elementList = data;
      //console.log(this.state.elementList.task_data.length, this.state.elementList.task_data);
    }
 //console.log(this.state.elementList.task_data.length)
